...
namespace Mollie.Api.Client
{
    public class PaymentMethodClient : BaseMollieClient, IPaymentMethodClient
    {
        ...
        public async Task<ListResponse<PaymentMethodResponse>> GetPaymentMethodIssuersListAsync(
            string locale = null,
            Amount amount = null,
            bool includeIssuers = false,
            bool includePricing = false,
            string profileId = null)
        {
            ...
            return await this.GetListAsync<ListResponse<PaymentMethodResponse>>("methods/?include=issuers", null, null, queryParameters).ConfigureAwait(false);
        }
